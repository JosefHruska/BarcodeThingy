...
import uk.org.okapibarcode.util.Gs1;
   */
    ...
    public void setContent(String data) {
        ...
        content = Verifier.verify(data, FNC1_STRING);
     ...
     */
        public int getHeight() {
            ...
            return symbol_height + (2 * quietZoneVertical);
        }
...
/*
     ...
     * @throws RuntimeException if no data or data is invalid
     *//*
        public void setContent(String data) {
     ...
     *//*
        protected void eciProcess() {
            ...
            if (EciMode.NONE.equals(eci)) {
                throw new RuntimeException("Unable to determine ECI mode.");
            }
