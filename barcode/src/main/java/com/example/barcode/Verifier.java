...
public class Verifier {
    ...
    public static String verify(String s, String fnc1) {
        ...
        for (int i = 0; i < source.length; i++) {
            if (source[i] >= 128) {
                throw new RuntimeException("Extended ASCII characters are not supported by GS1");
            }
            if (source[i] < 32) {
                throw new RuntimeException("Control characters are not supported by GS1");
            }
        }

        /* Make sure we start with an AI */
        if (source[0] != '[') {
            throw new RuntimeException("Data does not start with an AI");
        }
        ...
        if (bracket_level != 0) {
            ...
            throw new RuntimeException("Malformed AI in input data (brackets don't match)");
        }

        if (max_bracket_level > 1) {
            /* Nested brackets */
            throw new RuntimeException("Found nested brackets in input data");
        }

        if (max_ai_length > 4) {
            /* AI is too long */
            throw new RuntimeException("Invalid AI in input data (AI too long)");
        }

        if (min_ai_length <= 1) {
            /* AI is too short */
            throw new RuntimeException("Invalid AI in input data (AI too short)");
        }

        if (ai_latch) {
            /* Non-numeric data in AI */
            throw new RuntimeException("Invalid AI in input data (non-numeric characters in AI)");
        }
        ...
        for (int i = 0; i < ai_count; i++) {
            if (data_length[i] == 0) {
                ...
                throw new RuntimeException("Empty data field in input data");
            }
        }
        ...
        for (int i = 0; i < ai_count; i++) {
            ...
            if (error_latch == 1) {
                throw new RuntimeException("Invalid data length for AI");
            }

            if (error_latch == 2) {
                throw new RuntimeException("Invalid AI value");
            }
        }
